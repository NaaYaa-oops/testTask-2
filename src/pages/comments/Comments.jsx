...
export const Comments = () => {
    ...
    return (
        <div>
            <div><h1>Comments to: </h1>
                <strong>{posts[id - 1].title}</strong></div>
            ...
            <form onSubmit={submitHandler}>
                <div className="mb-3">
                    <label htmlFor="comment"><strong>Write a
                        comment:</strong></label>
                    <textarea className="form-control"
                              placeholder="Enter post body"
                              id="comment" minLength={6} maxLength={200}
                              ref={comment}/>
                </div>
                <button type="submit" className="btn btn-primary">Post comment.
                </button>
            </form>
        </div>
    )
